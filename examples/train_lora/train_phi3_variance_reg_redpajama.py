...
"""
Training script for Phi-3 Mini 4K Instruct with variance regularization using RedPajama v2 dataset.

This script demonstrates:
1. Using the massive RedPajama v2 dataset (1T+ tokens, 100K+ samples)
...
Usage:
    ...
    # Multi-GPU
    CUDA_VISIBLE_DEVICES=0,1 python examples/train_lora/train_phi3_variance_reg_redpajama.py
...
def main():
    # Training arguments for Phi-3 with variance regularization on RedPajama v2 dataset
    args = {
        # Model configuration
        ...
        # Dataset configuration - RedPajama v2
        "dataset": "redpajama_v2",
        "template": "phi",
        "cutoff_len": 1024,
        "max_samples": 100000,  # Use 100K samples from the massive dataset
        "overwrite_cache": True,
        "preprocessing_num_workers": 16,
        
        # Output configuration
        "output_dir": "./saves/phi3-variance-reg-redpajama",
        "logging_steps": 10,
        "save_steps": 500,
        "plot_loss": True,
    ...
    print("📊 Dataset: RedPajama v2 (1T+ tokens, 100K samples)")
